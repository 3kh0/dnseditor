      ...
      <tbody class="divide-y divide-border/10">
        ...
        >
          <td class="px-6 py-4 text-sm font-medium">
            <span v-html="light(record.type)"></span>
          </td>
          <td class="px-6 py-4 text-sm">
                ...
                >
                  <template v-if="record.type === 'MX'">
                    ...
                    <span
                      ...
                      "
                      v-html="
                        light((value.priority || value.preference).toString())
                      "
                    ></span>
                  ...
                  <template v-else>
                    <span v-html="light(value.toString())"></span>
                  </template>
                </li>
              </ul>
            </div>
            <div v-else>
              <template v-if="record.type === 'MX' && isMXRecord(record.value)">
                ...
                >,
                <span class="text-muted">Exchange: </span>
                <span v-html="light(record.value.exchange)"></span>
              </template>
              <template
                v-else-if="
              ...
              <template v-else>
                <span v-html="light(record.values.toString())"></span>
              </template>
            </div>
          </td>
        </tr>
